...
RMSK=UCSC.rmsk.sorted.bed

bedtools intersect -sorted -a ${DEG} -b ${i}.bed6 -wa > ${DEG}.${i}
bedtools intersect -sorted -a ${SRA} -b ${i}.bed6 -wa > ${SRA}.${i}
bedtools intersect -v -a ${DEG}.${i} -b ${RMSK} -sorted > ${DEG}.x_rmsk.${i}
bedtools intersect -v -a ${SRA}.${i} -b ${RMSK} -sorted > ${SRA}.x_rmsk.${i} 
...
# ## PP for SRA (unique mappers excluding RMSK mappers)
# gppc_internal.py -r 100 -a ${SRA}.x_rmsk.${i}.Watson -b ${SRA}.x_rmsk.${i}.Crick -p ${cpu} -c mm10.ChromInfo.txt > ${SRA}.x_rmsk.${i}.Watson.vs.${SRA}.x_rmsk.${i}.Crick
...
# ## PP for SRA (unique mappers)
# gppc_internal.py -r 100 -a ${SRA}.${i}.Watson -b ${SRA}.${i}.Crick -p ${cpu} -c mm10.ChromInfo.txt > ${SRA}.${i}.Watson.vs.${SRA}.${i}.Crick
...
## SRA phasing on Watson
gppc_internal.py -r 100 -a ${SRA}.x_rmsk.${i}.Watson -b ${SRA}.x_rmsk.${i}.Watson -p ${cpu} -c mm10.ChromInfo.txt > ${SRA}.x_rmsk.${i}.Watson.vs.${SRA}.x_rmsk.${i}.Watson
pps_plot.R ${SRA}.x_rmsk.${i}.Watson.vs.${SRA}.x_rmsk.${i}.Watson

## SRA phasing on Crick
gppc_internal.py -r 100 -a ${SRA}.x_rmsk.${i}.Crick -b ${SRA}.x_rmsk.${i}.Crick -p ${cpu} -c mm10.ChromInfo.txt > ${SRA}.x_rmsk.${i}.Crick.vs.${SRA}.x_rmsk.${i}.Crick
pps_plot.R ${SRA}.x_rmsk.${i}.Crick.vs.${SRA}.x_rmsk.${i}.Crick



# ## DEG vs SRA
# ## 5' DEG-5' SRA distance on Watson
# gppc_internal.py -r 100 -a ${DEG}.x_rmsk.${i}.Watson -b ${SRA}.x_rmsk.${i}.Watson -p ${cpu} -c mm10.ChromInfo.txt > ${DEG}.x_rmsk.${i}.Watson.vs.${SRA}.x_rmsk.${i}.Watson
# pps_plot.R ${DEG}.x_rmsk.${i}.Watson.vs.${SRA}.x_rmsk.${i}.Watson

# ## 5' DEG-5' SRA distance on Crick
# gppc_internal.py -r 100 -a ${DEG}.x_rmsk.${i}.Crick -b ${SRA}.x_rmsk.${i}.Crick -p ${cpu} -c mm10.ChromInfo.txt > ${DEG}.x_rmsk.${i}.Crick.vs.${SRA}.x_rmsk.${i}.Crick
# pps_plot.R ${DEG}.x_rmsk.${i}.Crick.vs.${SRA}.x_rmsk.${i}.Crick

# ## 5' DEG-5' SRA on different strands
# gppc_internal.py -r 100 -a ${DEG}.x_rmsk.${i}.Watson -b ${SRA}.x_rmsk.${i}.Crick -p ${cpu} -c mm10.ChromInfo.txt > ${DEG}.x_rmsk.${i}.Watson.vs.${SRA}.x_rmsk.${i}.Crick
# pps_plot.R ${DEG}.x_rmsk.${i}.Watson.vs.${SRA}.x_rmsk.${i}.Crick

# gppc_internal.py -r 100 -a ${DEG}.x_rmsk.${i}.Crick -b ${SRA}.x_rmsk.${i}.Watson -p ${cpu} -c mm10.ChromInfo.txt > ${DEG}.x_rmsk.${i}.Crick.vs.${SRA}.x_rmsk.${i}.Watson
