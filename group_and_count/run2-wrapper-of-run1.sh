for i in 00 02 04 07 10 12 14 17 20 42; do
    # i=02
    dpp=${i}dpp
    bed2=/data/fuy2/prepachytene/results/2014-11-21/SRA_mm10g/${dpp}/genome_mapping/Zamore.SRA.total.${dpp}.testis.trimmed.x_rRNA.x_hairpin.mm10gv1.all.piRNA.bed2
