...
# for i in 02; do
    ...
    awk '{ l=$3-$2; if(l>=20 && l<=22 && $5==1) {print} }' ../2014-11-21/SRA/${i}dpp/genome_mapping/Zamore.SRA.total.${i}dpp.testis.trimmed.x_rRNA.x_hairpin.mm9v1.all.bed2 | sort -k1,1 -k2,2n > ${i}dpp.uniq.siRNA.bed2 && \
    ...
    awk '{ l=$3-$2; if(l>=20 && l<=22) {print} }' ../2014-11-21/SRA/${i}dpp/genome_mapping/Zamore.SRA.total.${i}dpp.testis.trimmed.x_rRNA.x_hairpin.mm9v1.all.bed2 | sort -k1,1 -k2,2n > ${i}dpp.all.siRNA.bed2 && \
