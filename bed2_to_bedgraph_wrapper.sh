...
for i in 02; do
    n=$(grep 'genome mapping reads (-rRNA; +miRNA_hairpin)' 00dpp.basic_stats | grep -E -o '[0-9]+')
    ...
    # 	bed2_to_bedgraph.py ${i}dpp.all.siRNA.bed2 ${i}dpp.all.Watson.bedgraph ${i}dpp.all.Crick.bedgraph && \
