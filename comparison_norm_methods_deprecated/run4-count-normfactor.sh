...
function get_normfactor() {
    D=$1
# for D in SRS.42A18AT1.br2.tr1.ox.ovary; do
...
# for D in SRS.GS1CT1.br2.tr1.ox.ovary; do
    ...
    INPUT_ROOT=/home/fuy2/data/gfp_pirna/data
    PREFIX=$D
    ...
    # D=../../SRS.GS1CT1.br1.tr1.ox.ovary
    PREFIX_MAPPER=${INPUT_ROOT}/${D}/genome_mapping/${PREFIX}.x_rRNA.x_hairpin.dm3_chengjianv0
...
for D in SRS.42A18AT1.br4.tr2.ox.ovary; do
    echo "get_normfactor $D"
done | parallel --progress -j 16
